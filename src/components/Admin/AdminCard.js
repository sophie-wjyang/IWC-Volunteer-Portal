    ...
    return (
        <Card className="opportunity-card">
            <Card.Body>
                ...
                <h5>{opportunity.data().organization} {opportunity.data().partnership ? (<Badge style={{ backgroundColor: "#55BCC9" }} variant="info">IWC Partnership</Badge>) : (<Badge style={{ backgroundColor: "#55BCC9" }} variant="info">Opportunity</Badge>)}</h5>
                ...
                <Button style={{ backgroundColor: "#FC4445", border: "#FC4445" }} onClick={() => {setShowModal(true)}}>Edit</Button>
            </Card.Body>
